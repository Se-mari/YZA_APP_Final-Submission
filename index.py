...
from yzapps.modules import customers_profile, occupation, occupation_profile, transaction, transaction_profile, inventory, payment, payment_profile
CONTENT_STYLE = {
"margin-left": "12rem",
"margin-right": "2rem",
"padding": "2rem 1rem",
    ...
    if ctx.triggered:
        ...
        if eventid == 'url':
            if userid < 0 or pathname== '/signup': 
                ...
                elif pathname == '/modules/payment':
                    returnlayout = payment.layout
                elif pathname == '/modules/payment_profile':
                    returnlayout = payment_profile.layout
